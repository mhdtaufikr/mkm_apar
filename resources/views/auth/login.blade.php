...
<head>
    ...
    <title>Digital APAR Checkhseet Maintenance</title>
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5 card-animation custom-card">
                                <div class="card-body">
                                    ...
                                    <div class="text-center mb-4">
                                        ...
                                        <h1 class="text-center font-weight-bold" > <strong>APAR Checksheet</strong></h1>
                                        <small  class="text-center mb-4">Digital APAR Checkhseet Maintenance</small>
                                    </div>
